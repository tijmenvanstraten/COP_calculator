...
SENSOR_OUTLET_TEMP = "sensor.shelly_temperatuursensoren_warmtepomp_temperatuur_2"
SENSOR_INLET_TEMP = "sensor.shelly_temperatuursensoren_warmtepomp_temperatuur"
